...
* **Ensure the bug was not already reported** by searching on GitHub under [Issues](https://github.com/SolaceSamples/solace-samples-springboot/issues).
...
* Search [GitHub](https://github.com/SolaceSamples/solace-samples-springboot/pulls) for an open or closed Pull Request
...
Fork the project [on GitHub](https://github.com/SolaceSamples/solace-samples-springboot) and clone your fork
locally.

```sh
git clone https://github.com/<my-github-repo>/solace-samples-springboot
```
...
```sh
$ git remote add upstream https://github.com/SolaceSamples/solace-samples-springboot
```
...
In GitHub, send a pull request to `solace-samples-springboot:master`.
...
* Open a GitHub [enhancement request issue](https://github.com/SolaceSamples/solace-samples-springboot/issues/new) and describe the new functionality.
